  ...
  <div class="row">
    ...
    <div class="col-md-6 offset-md-3">
      <div class="card my-5">
        ...
        <form class="card-body cardbody-color p-lg-5" action="{{ route('loginAction') }}" method="POST">
            @csrf
          ...
          <div id="emailHelp" class="form-text text-center mb-5 text-dark">Not Registered? <a href="{{ route('registerPage') }}" class="text-dark fw-bold">Register</a>
          </div>
        </form>
      </div>
